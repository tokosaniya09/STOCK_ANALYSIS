...
const StockInfo = () => {
  ...
  return (
    <div className="about stock p-4 md:p-8 lg:p-16">
      <div>
        <h1 className="text-2xl font-bold mb-4">Stock Market Basics</h1>
        <p className="mb-6">
        ...
        <div className="space-y-4">
          {stockTerms.map((item, index) => (
            <div key={index} className="border p-4 rounded-lg shadow-md bg-white">
              ...
              <p className="text-gray-600"><span className="font-medium">Example:</span> {item.example}</p>
            </div>
          ))}
        </div>
      </div>
