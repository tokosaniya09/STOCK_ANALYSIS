...
export default function AboutPage() {
  ...
  return (
    ...
    <ul className='reveal'>
      ...
      <li className='reveal'><h3>In-Depth Tracking Tools</h3></li>
      <p className='reveal'>Our suite of tools allows you to see market data, assess stock performance, and understand the financial landscape like never before.</p>
      ...
      <p className='reveal'>Whether mid cap companies or large cap enterprises, our tracking adapts to your strategies, bringing value to investors of every level.</p>
    </ul>
